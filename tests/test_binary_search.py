...
def test_binary_search_normal_cases():
    # Test finding elements in the middle, at beginning, and at end
...
def test_binary_search_large_sorted_array():
    ...
    large_array = list(range(0, 1000, 2))
    assert binary_search(large_array, 500) == large_array.index(500)
    assert binary_search(large_array, 501) == -1